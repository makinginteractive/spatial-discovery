...
export type CanvasProductsQueryVariables = StorefrontAPI.Exact<{
  first: StorefrontAPI.Scalars['Int']['input'];
}>;

export type CanvasProductsQuery = {
  products: {
    nodes: Array<
      Pick<
        StorefrontAPI.Product,
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query CanvasProducts($first: Int!) {\n    products(first: $first, sortKey: CREATED_AT) {\n      nodes {\n        id\n        title\n        handle\n        description\n        productType\n        priceRange {\n          minVariantPrice {\n            amount\n            currencyCode\n          }\n        }\n        featuredImage {\n          url\n          altText\n        }\n        images(first: 5) {\n          nodes {\n            url\n            altText\n          }\n        }\n        variants(first: 1) {\n          nodes {\n            id\n            availableForSale\n          }\n        }\n      }\n    }\n  }\n': {
    return: CanvasProductsQuery;
    variables: CanvasProductsQueryVariables;
  };
